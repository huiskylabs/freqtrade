# Research TP ScaleOut variant — 50% at +3R
from __future__ import annotations
from datetime import datetime
from freqtrade.persistence import Trade
from TrendPullbackScaleOutModerate import TrendPullbackScaleOutModerate

class TrendPullbackModSO50at30(TrendPullbackScaleOutModerate):
    book_tag = "MODSO50AT30"
    position_adjustment_enable = True
    max_entry_position_adjustment = 0
    # rules: (exits_done, r_min, frac_of_initial, tag)
    SCALE_RULES = [(0, 3.0, 0.5, 'scale_out_3R')]
