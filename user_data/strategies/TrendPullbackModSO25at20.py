# Research TP ScaleOut variant — 25% at +2R
from __future__ import annotations
from datetime import datetime
from freqtrade.persistence import Trade
from TrendPullbackScaleOutModerate import TrendPullbackScaleOutModerate

class TrendPullbackModSO25at20(TrendPullbackScaleOutModerate):
    book_tag = "MODSO25AT20"
    position_adjustment_enable = True
    max_entry_position_adjustment = 0
    # rules: (exits_done, r_min, frac_of_initial, tag)
    SCALE_RULES = [(0, 2.0, 0.25, 'scale_out_2R_25')]
